...
export const Product = (props) => {
    ...
    useEffect(() => {
        //metodo get para obtener el objeto por el Id pasado por parametro
        const getOneArticulo = async (prodId) => {
            const { data } = await axios.get();
            //filtra los datos segun ID pasado por parametro
                    ...
                    (<div className="p-2 align-items-center rounded-3 border border-info shadow-lg">
                        <div className="row">
                            ...
                            <div className="col-lg-4 p-3 position-relative">
                                ...
                                <img src={producto?.image} className="fit-image border border-dark rounded-2" height="350px" alt="imagen-1"></img>
